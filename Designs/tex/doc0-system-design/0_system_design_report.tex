...
\textbf{Source}         & \fpath{Designs/tex/doc0-system-design/0_system_design_report.tex} \\
\end{tabular}
\end{minipage}
\end{center}
...
\fpath{Designs/tex/docL-legacy-architecture/L_legacy_system_architecture.pdf} (Doc L).
\end{keynote}
