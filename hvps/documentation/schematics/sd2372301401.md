# HVPS Schematic SD2372301401 - Detailed Circuit Analysis for AI Design
...
This document provides detailed circuit analysis of HVPS schematic sd2372301401 extracted through advanced PDF analysis techniques. The schematic contains comprehensive circuit topology, precise component specifications, and electrical design details critical for AI-driven circuit design and analysis. This analysis enables AI systems to understand the complete circuit design and generate accurate circuit implementations.

## Technical Specifications Extracted

### Electrical Parameters
- **Voltages:** 3.3, 5, 10, 15, 430, 50, 415, 7, 4, 33
- **Currents:** 3064, 2, 23, 5, 4, 6, 1, 3, 404
- **Power:** 20, 78, 315, 3064, 39, 2, 6, 1, 3
- **Capacitances:** 001, 7f, 5uF, 10, 5, 0.001, 2F, 7UF, 7, 10F
- **Inductances:** 10, 14, 14H, 10h

### Component Count Analysis
- **Total Components Identified:** 157
- **Component Categories:** 2 L, 12 D, 10 N, 12 P, 33 C, 58 R, 11 U, 3 F, 2 J, 13 IC, 1 TRANSFORMER

## Detailed Circuit Topology


```
HVPS CIRCUIT DETAILED TOPOLOGY - SD2372301401

Input -----> [Circuit Block] -----> Output
             sd2372301401

Detected Components: L2, D20, N4728, P9, C20, R34, R3, R33
Operating Voltages: 3.3, 5, 10 kV
...
- FORNLCTA Pwse [ye | Wi | sais
- ep fe 9}
- (FOR NLCTA P/S) UNLESS OTHERWISE SPECIFIED: v, RP
- FORNLCTA Pwsa Ppo | Mi [sais
- (FOR 2MW PEP II P/S) UNLESS OTHERWISE SPECIFIED: NOTES: (FOR NLCTA P/S) UNLESS OTHERWISE SPECIFIED: v, ab tg Kz
- FORNLCTA Pus [ye | Wi | sais
- ep fe Pp}
- (FOR NLCTA P/S) UNLESS OTHERWISE SPECIFIED: v, a RP
