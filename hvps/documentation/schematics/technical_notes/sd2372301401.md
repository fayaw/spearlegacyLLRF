...
|------------|-------------|----------|-------------------|
| **U1** | BUF634 | Buffer amplifier | POS. CURRENT SENSE MONITOR buffer |
| **U2** | OP77 | Precision op-amp | Isolated current preamp, R54 (10.00K) feedback |
| **U11A** | INA117 | Instrumentation amp | Voltage difference amplifier, 10.00K feedback |
| **U13** | INA117 | Instrumentation amp | Voltage limit amplifier, 4.99K input, 500pF comp |
| **U20** | INA114/INA117 | Instrumentation amp | Precision current measurement configuration |
| **MC34074** | Quad op-amp | Signal processing | Control loops and comparators |
| **CD4044B** | Quad RS latch | Protection logic | Multiple trip inputs |
| **4N32** | Optocoupler | Galvanic isolation | 6× isolation for SCR gate drive |
