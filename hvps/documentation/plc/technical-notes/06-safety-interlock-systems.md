...
## 9. Enerpro Phase Loss Detection (Rung 116)

**Purpose:** Detects loss of Enerpro phase while contactor is closed.

**Logic:**
- **Conditions:** B3:1/11 (Contactor Closed Display) is HIGH AND I:7/11 (Enerpro Phase Loss) goes LOW (inverted — loss detected)
- **Output:** Latches B3:5/3 (_ENERPRO_PHASE_LOSS)
- **Reset:** B3:5/3 is unlatched in Rung 1 (momentary reset)

**Note:** This interlock only triggers while the contactor is closed, preventing false alarms during startup/shutdown when phase loss is expected.

---

## 10. Composite Interlock Chains

### Transformer Latched OK (B3:2/1 — Rung 60)

All of the following must be clear for B3:2/1 to be TRUE:
- B3:4/0 (Pressure Latch) from Rung 41
- B3:4/1 (Oil Temp Latch) from Rung 43
- B3:4/2 (SCR Oil Tank Level) from Rung 44
- B3:4/3 (Low Oil Latch) from Rung 45
- B3:2/7 (Water Flow Switch) from Rung 50
- B3:4/7 (Oil Pump Flow) from Rung 47
- B3:2/1 is used in the enable chain and contactor ready logic

### No Transformer Fault (B3:0/9 — Rung 61)

All of the following I/O inputs must be in their OK state:
- I:7/4 (Transformer Pressure OK)
- I:7/5 (Transformer Vacuum OK)
- I:7/6 (Transformer Over Temperature OK)
- I:7/7 (Transformer Oil Level OK)
- I:7/8 (Transformer Sudden Pressure OK)
- I:6/10 (Crowbar Oil Level OK)
- I:6/11 (SCR Oil Level OK)
- I:6/8 (Ground Tank Oil Level OK)

### Contactor OK (B3:2/2 — Rung 58)

- B3:2/1 (Transformer Latched OK) must be TRUE
- I:7/0 (Contactor Blocking Relay) must be clear
- I:7/1 (Contactor Overcurrent) must be clear
- Sets B3:4/5 (Over Current Trip Latch)
