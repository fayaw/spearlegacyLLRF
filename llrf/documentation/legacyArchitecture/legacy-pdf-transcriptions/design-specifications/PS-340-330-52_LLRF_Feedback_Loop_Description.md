...
```
+----------------------------------------------------------------------------------------------------------------------------------+
|  LOW-LEVEL RF FBK LOOPS  Block Diagram #1    (ON_CW with Direct Loop ON)                                                         |
+----------------------------------------------------------------------------------------------------------------------------------+
|                                                                                                                                  |
|                        +-----------------+                                                  +---------+                          |
...
|                |   <-------------------------------------------  |             |           |          |                          |
|                |                             Kly Out Fwd Phase   +------------>+     +-----+---------+                           |
|           (S)<-(S)<───── Kly Out Fwd Phase ──────────────────────+          (S)      | Fixed Offset   |                          |
|                ^                                                              ^        +---------------+                         |
|           Ripple Loop Phase Ref                                               |                                                  |
|                |                                                              +─── from Kly Fwd Σ                                |
|           Error|                                                                                                                 |
|                                                                                                                                  |
|                |                  DIRECT LOOP (800 kHz)                                                                          |
|                                                                                                                                  |
|           (S)<-(S)<──────────────────────────────────────── from Probe Phase (S) ─────────────────────                           |
|  +----------+   ^                                                                                                                |
|  |  GAP     |   |  Error                                                                                                         |
|  |  FF      +---+                                                                                                                |
|  |  LOOP    |                          COMB LOOP (2 MHz)                                                                         |
|  | (100 Hz) |                                                                                                                    |
|  +----+-----+         (S)<-(S)<──────────────────────── from Probe Phase (S) ────────────────────────                            |
|       |                     ^                                                                                                    |
|       |                     |        +--------------------+                                                                      |
|       |                     +<───────+  Digital Comb      +<─── from Cavity probe (Probe Ph. Σ) ─────                            |
|       |                              |     Filter         |                                                                      |
|       |                              +--------------------+                                                                      |
|       v                                                                                                                          |
|  +-------+                                                                                        (S)                            |
