...
flowchart LR
    ...
    TS6 <-->|"70 ft cable\nBELDEN 83709 TEF + COAX RG-58"| CABLE
...
```
 ...
 │ ─── ─────────────────  │  BELDEN 88761 TEF Twisted Shielded   │  COIL ── NO ── COM ── NC     │
 ...
 LEGEND:
  ────►  Twisted shielded signal wire (BELDEN TEF)
  ════►  Coaxial cable (RC-S8)
...
|------|------------|-------|
| Control cable | BELDEN 88761 TEF, Twisted Shielded | 70 ft run, B118 ↔ Grounding Tank |
