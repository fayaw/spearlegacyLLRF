...
The final hop — which **GOB1208PNE** pins carry it — remains an **unconfirmed assumption** per J. Sebek. See `Designs/tex/docL-legacy-architecture/L_legacy_system_architecture.pdf` §13.2.1.
