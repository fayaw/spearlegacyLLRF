...
|---|------|-----------|-------------|
| 0 | [00_SYSTEM_OVERVIEW.md](00_SYSTEM_OVERVIEW.md) | All | Master system architecture, PPS chain overview, physical layout |
...
1. K4/RR relay labels swapped on WD-730-794-02-C0
2. L1/L2 coil labels incorrect on GP-439-704-02-C1
3. Manual grounding switch contact type (NO vs NC) inconsistent
